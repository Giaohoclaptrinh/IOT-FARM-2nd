...
const EditDevice = ({ device, onClose, enableShow }) => {
    ...
    return (
        <OverLay onClose={onClose}>
            <div className="bg-white w-96 p-8 rounded-lg shadow-lg max-w-lg max-w-full ">
                ...
                <div className="flex justify-between">
                    ...
                    <button
                        className="bg-gray-500 text-white px-6 py-3 rounded-lg text-lg hover:bg-gray-700"
                        onClick={onClose}
                    >
                        Hủy
                    </button>
